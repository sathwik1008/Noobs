...
/* Test case text
<script>document.getElementById("demo").innerHTML="HelloJavaScript!";</script>document.getElementById("demo").style.fontSize=“25px";document.getElementById("demo").style.color=“red";document.getElementById("demo").style.backgroundColor=“yellow";document.getElementById("image").src=“picture.gif";<style>body{background-color:powderblue;}h1{color:red;}p{color:blue;}</style>
*/
